    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <button class="btn btn-sm {{ $bill->due_amount == 0 ? 'btn-success' : 'btn-warning' }} mark-paid-button" data-id="{{ $bill->id }}" data-final-amount="{{ $bill->final_amount }}" data-due-amount="{{ $bill->due_amount }}">
                ...
                <td>
                    ...
                    <a href="{{ route('admin.bill.paymentHistory', ['bill' => $bill->id]) }}" class="btn btn-info btn-sm">Payment History</a>
                </td>
            </tr>
            @endforeach
        </tbody>
